...
TABLE_DEFINITIONS = [
    ...
    },
    {
        ...
        "fields": [
            ...
            {"name": "supporting_evidence", "type": "multilineText"},
            {"name": "contradicting_evidence", "type": "multilineText"},
            {"name": "investigation_path", "type": "multilineText"},
            {"name": "hypotheses", "type": "multilineText"},
